...
ActiveRecord::Schema.define(:version => 20120703191943) do

  create_table "bcms_rankings_page_ranking_versions", :force => true do |t|
  ...
  create_table "bcms_rankings_page_rankings", :force => true do |t|
    t.integer  "version"
